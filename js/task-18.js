...
console.log(makeTransaction(3000, 5, 23000)) // 'Вы купили 5 дроидов, на счету осталось 8000 кредитов'.
console.log(makeTransaction(1000, 3, 15000)) // 'Вы купили 3 дроидов, на счету осталось 12000 кредитов'.
console.log(makeTransaction(5000, 10, 8000)) // 'Недостаточно средств на счету!'.
console.log(makeTransaction(2000, 8, 10000)) // 'Недостаточно средств на счету!'.
console.log(makeTransaction(500, 10, 5000)) // 'Вы купили 10 дроидов, на счету осталось 0 кредитов'.